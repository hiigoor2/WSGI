<div class="col-sm-9 panel panel-default" id="conteudo">
    <div class="col-md-12">
        ...
        <form action="<?= base_url('Sala/Gravar') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
                ...
                <!-- Form Name -->
                <h3><strong>Gerenciar salas:</strong></h3>
                <br/>
                <br/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="descricao" minlength="5" name="descricao" placeholder="Descrição" value="<?= isset($sala) ? $sala->getDescricao() : '' ?>" class="form-control input-md" required="true" type="text"> 
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="capacidade">Capacidade</label>  
                    <div class="col-md-4">
                        <input id="capacidade" name="capacidade" placeholder="Capacidade" value="<?= isset($sala) ? $sala->getCapacidade() : '' ?>" class="form-control input-md" required="true" type="number"> 
                    </div>
                </div>
                <br/>
                <br/>
    ...
    <div class="col-md-12">
        <h5 class="page-header"><strong><p class="text-primary"><span class="glyphicon glyphicon-list"></span> Salas</strong></p></h5>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                for ($i = 1; $i <= $qtde_botoes; $i++) :
                    ?>
                    <li><a <?= $pag == $n_pag ? 'style="pointer-events: none; background-color: #CCC;' : '' ?> href="<?= base_url('Sala/pag/' . $n_pag) ?>"><?= $i ?></a></li>
                    <?php
                    $n_pag+=$max_registros;
                endfor;
                ?>
